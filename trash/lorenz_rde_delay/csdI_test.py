...
def main():
    ...
    default_model_path = os.path.join(lorenz_dir, 'save', 'model.pth')
    default_config_path = os.path.join(lorenz_dir, 'config', 'lorenz.yaml')
    parser.add_argument("--model_path", type=str, default=default_model_path, help="Path to saved model.pth")
    parser.add_argument("--config_path", type=str, default=default_config_path, help="Path to config file")
