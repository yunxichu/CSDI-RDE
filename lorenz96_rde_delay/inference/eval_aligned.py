...
def main():
    ...
    print("=" * 80)
    print(f"Lorenz96: CSDI Imputation + RDE/RDE-Delay Prediction | seed={args.seed}")
    print("=" * 80)

    print("\nStep 0: Generate Lorenz96 data")
    full_data = lorenz96_generate(N=lorenz_N, T=lorenz_T, forcing=8.0, seed=args.seed)
    ...
    aligned = {"seed": args.seed, "timestamp": timestamp,
               ...
               "target_dim": pred_target_idx, "dataset": "lorenz96"}
    if result_rde_imp is not None:
