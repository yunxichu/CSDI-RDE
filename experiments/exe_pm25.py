...
foldername = os.path.join(base_dir, "rde_gpr", "csdi", "save", f"pm25_validationindex{args.validationindex}_{current_time}")
...
if args.modelfolder == "":
    ...
    model.load_state_dict(torch.load(os.path.join(base_dir, "rde_gpr", "csdi", "save", args.modelfolder, "model.pth")))
