"""Lorenz96 N=10 trajectory figure for §5.9.

N=10 ring: d_KY ≈ 4, λ_1 ≈ 1.68. Three representative ring positions.
"""
...
OUT = REPO / "pictures" / "l96N10_trajectory_final.png"
OUT.parent.mkdir(parents=True, exist_ok=True)

N = 10
F = LORENZ96_F_DEFAULT
DT = 0.05
LYAP = LORENZ96_LYAP_F8
ATTR_STD = lorenz96_attractor_std(N=N, F=F)  # 3.612 for N=10
N_CTX, PRED_LEN = 512, 128
CKPT = REPO / "experiments/week2_modules/ckpts/dyn_csdi_l96_N10_full_vales_best.pt"
...
def plot(results):
    ...
    fig.suptitle(f"Lorenz96 N={N} forecast — seed {SEED}, n_ctx={N_CTX}, "
                 f"pred_len={PRED_LEN}  (λ={LYAP:.2f}, σ_attr={ATTR_STD:.2f})",
                 fontsize=11)
    plt.tight_layout()
