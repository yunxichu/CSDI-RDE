# exe_lorenz.py
'''
cd /home/rhl/Github/lorenz/training && python exe_lorenz.py --device cpu --seq_len 50 --seq_count 100 --batch_size 8
'''
...
from models.main_model import CSDI_Lorenz
from data.dataset_lorenz import get_dataloader
...
# load config
config_path = os.path.join(lorenz_dir, 'config', args.config)
