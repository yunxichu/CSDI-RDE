...
class PM25_Dataset(Dataset):  # 定义一个处理PM2.5数据的数据集类，继承自Dataset
    ...
    def __getitem__(self, org_index):  # 获取单个样本的方法
        ...
        s = {
            ...
            "gt_data": self.gt_data[c_month][
                c_index : c_index + self.eval_length  # 获取真实值数据片段
            ],
