...
OUT_DIR="./experiments_v2/lorenz63/sssd_v2"

mkdir -p ${LOG_DIR} ${OUT_DIR}

LOG_FILE="${LOG_DIR}/lorenz63_sssd_v2_$(date +%Y%m%d_%H%M%S).log"

echo "============================================" | tee -a ${LOG_FILE}
echo "  Lorenz63 SSSD 训练 - GPU ${GPU}" | tee -a ${LOG_FILE}
...
python3 baselines/sssd_forecast.py \
    --dataset lorenz63 \
    --ground_path ./lorenz_rde_delay/results/gt_100_20260320_110418.csv \
    --data_path ./lorenz_rde_delay/results/imputed_100_20260320_110418.csv \
